...
def plotdiff(Lon,Lat,diffam,diffph,name):
    ...
    fname=os.path.join(path1,'postprocessing','test_K1',name+'.jpg')
...
# 1. FEK1014, 2. Altimetry 3. GTSM v4.1

# reading of all these datasets. 

#FES data
fesfile=os.path.join(path1,'postprocessing','test_K1','FESK1canada.nc')
(Fstavec,Ftidvec)=readdata.readtidedata(fesfile)

#GTSM data
gtsmfile=os.path.join(path1,'postprocessing','test_K1','GTSMK1canada.nc')
(Gstavec,Gtidvec)=readdata.readtidedata(gtsmfile)

#no K1 altimetry data available yet
# #Altimetry data
# altfile=os.path.join(path1,'Altimetry_vanInger','ModK1Arctic_altimetry.nc')
...
#model fes b
modelffile=os.path.join(path1,'postprocessing','test_K1','ModK1fesb.nc')
...
#model fes b
modelffile=os.path.join(path1,'postprocessing','test_K1','ModK1gtsmb.nc')
(Mfstavec,Mftidvec)=readdata.readtidedata(modelffile)
...
# reading of the model results 
#model fes b
modelffile=os.path.join(path1,'postprocessing','test_K1','ModK1ficefesb.nc')
(Mfstavec,Mftidvec)=readdata.readtidedata(modelffile)
...
#model fes b
modelffile=os.path.join(path1,'postprocessing','test_K1','ModK1ficegtsmb.nc')
(Mfstavec,Mftidvec)=readdata.readtidedata(modelffile)
...
# reading of the model results 
#model fes b
modelffile=os.path.join(path1,'postprocessing','test_K1','ModK1fice37fesb.nc')
(Mfstavec,Mftidvec)=readdata.readtidedata(modelffile)
...
#model fes b
modelffile=os.path.join(path1,'postprocessing','test_K1','ModK1noicenobottomfesb.nc')
(Mfstavec,Mftidvec)=readdata.readtidedata(modelffile)
...
# reading of the model results 
#model fes b
modelffile=os.path.join(path1,'postprocessing','test_K1','ModK1fice18fesb.nc')
(Mfstavec,Mftidvec)=readdata.readtidedata(modelffile)
...
# reading of the model results 
#model fes b
modelffile=os.path.join(path1,'postprocessing','test_K1','ModK1salfesb.nc')
(Mfstavec,Mftidvec)=readdata.readtidedata(modelffile)
...
# reading of the model results 
#model gtsm
modelffile=os.path.join(path1,'postprocessing','test_K1','ModK1salgtsmb.nc')
(Mfstavec,Mftidvec)=readdata.readtidedata(modelffile)
