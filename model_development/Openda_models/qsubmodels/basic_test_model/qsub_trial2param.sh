...
cd /u/vasulkar/p_emodnet_amey/Regional_canada_model/model_development/Openda_models/basic_test_model
...
touch /u/vasulkar/p_emodnet_amey/Regional_canada_model/model_development/Openda_models/basic_test_model/trial2param.done
