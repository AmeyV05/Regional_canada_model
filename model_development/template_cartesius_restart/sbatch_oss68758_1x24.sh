...
#SBATCH -t 5-00:00:00           #reduce the expected time if possible to increase your priority
...
# Partition model
dflowfm --partition:ndomains=24:icgsolver=6 gtsm_model.mdu
srun -N 1 -n 24 dflowfm --autostartstop gtsm_model.mdu
