...
dimrdir=/p/d-hydro/dimrset/weekly/2.17.12_patch01.73720 #2022.01 including patch
...
dimrFile=dimr.xml
mduFile=canada_model_dummy.mdu
...
$dimrdir/lnx64/bin/run_dflowfm.sh $mduFile --savenet