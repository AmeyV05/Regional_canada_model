...
#SBATCH --job-name=salbathcooHBgtsmboundaryruns_1x24
#SBATCH -t 05:00:00
#SBATCH --constraint=haswell
cd /home/vasulkar/einf220/AV/canada_model/third_boundary_test_runs/salbathcooHBgtsmboundaryruns
# load modules
module purge
module load 2019
...
touch /home/vasulkar/einf220/AV/canada_model/third_boundary_test_runs/salbathcooHBgtsmboundaryruns/sim.done
Merging map files.
dfmoutput mapmerge --listfile listmapfilescartesius.txt
touch /home/vasulkar/einf220/AV/canada_model/third_boundary_test_runs/salbathcooHBgtsmboundaryruns/merge.done
